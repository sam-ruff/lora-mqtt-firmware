...
TARGET_BUILD="target/xtensa-esp32s3-none-elf/release/lora-mqtt-hub-firmware"
...
if [ ${#FAILED[@]} -eq 0 ]; then
    ...
    echo "until power-cycled. A running board shows up as 'LoRaMqttHub'"
    echo "with USB serial 'LMH-XXXXXX'."
else
